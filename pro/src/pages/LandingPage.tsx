      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto text-center">
          <div className="flex justify-center mb-8">
            <Wand2 className="h-16 w-16 text-blue-400" />
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative">
              <textarea
                ...
                className="w-full p-4 h-32 text-lg bg-gray-800 text-white border-2 border-gray-700 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-500/50 transition-all duration-200 resize-none placeholder-gray-500"
              />
            </div>
            <button
              type="submit"
